...
export const TextInput = (props: TextInputProps) => {
  ...
  return (
    <div className={styles.textInput}>
      <input value={props.inputValue} className={styles.passInput} type="text" placeholder={"P4$5W0rD!"} />
      <button className={styles.textInputButton} onClick={handleButtonClick}>
        { isTextVisible && <p className={styles.flowingAlert}>copied</p> }
